...
## Follow-up To-do
- [ ] [added: 2026-02-28] 다음 패치부터 본 문서에 엔트리 누락 없이 기록
- [ ] [added: 2026-02-28] 모든 엔트리에 커밋 SHA와 검증 상태 포함
- [ ] [added: 2026-02-28] 릴리즈 버전 매핑 규칙 확정
- [ ] [added: 2026-02-28] 롤백 수행 시 사유/결과 필수 기록
