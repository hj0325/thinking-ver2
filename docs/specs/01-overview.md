...
## Follow-up To-do
- [ ] [added: 2026-02-28] [P0] 영어 전용 정책 범위를 확정한다 (UI, 오류 메시지, AI 응답, fallback 문구 포함 여부).
- [ ] [added: 2026-02-28] [P0] 현재 한/영 혼합 상태를 영어 전용 상태로 전환하는 릴리즈 목표일을 확정한다.
- [ ] [added: 2026-02-28] [P1] 런타임 표준 경로를 확정한다 (Next API 단일화 vs Python backend 병행).
- [ ] [added: 2026-02-28] [P1] README 및 운영 문서를 현재 `pages` 구조 기준으로 업데이트한다.
